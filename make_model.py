...
#parameters
working_dir = '/home/diptanshu/Documents/Shape_detect'
...
#-------------get train/test data-----------------
#get data
folders, labels, images = ['triangle', 'star', 'square', 'circle','semicircle','rectangle'], [], []
...
#neurons: 256
model = Sequential()
model.add(Dense(256, activation = 'relu', input_shape = (dataDim,)))
...
#save model
model.save('/home/diptanshu/Documents/Shape_detect/shapesmodel.h5')
